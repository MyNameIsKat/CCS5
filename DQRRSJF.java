...
//CODE CREDIT : GEEKSFORGEEKS.ORG


public class DQRRSJF {
    ...
    public static void main(String[] args){ 
        ...
        int burst_time[] = {10, 25, 32, 7, 3,12,5,8,15,1, 14, 19, 8,12,7,21,13,41,8,2};
        //SORT SJF BY BURST TIME
        Arrays.sort(burst_time);
        int burst_sum = 0;
        //BURST TIME CALC FOR DYNAMIC TQ
        for(int i = 0; i < burst_time.length; i++){
            burst_sum += burst_time[i];
        }
        
        // Time quantum 
        int quantum = (burst_sum/burst_time.length); 
